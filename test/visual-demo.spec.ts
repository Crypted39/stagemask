...
test.describe('Hard Assertions (visualSnapshot)', () => {
  ...
  test('dashboard card - stops on first failure', async ({ page, visualSnapshot }) => {
  ...
  test('profile card - stops on first failure', async ({ page, visualSnapshot }) => {
...
test.describe('Soft Assertions (softVisualSnapshot)', () => {
  ...
  test('all cards - continues after failures', async ({ page, softVisualSnapshot }) => {
  ...
  test('multiple screenshots in sequence', async ({ page, softVisualSnapshot }) => {
