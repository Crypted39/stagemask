...
export function App() {
  ...
  const [selectedScreenshot, setSelectedScreenshot] = useState<FailedScreenshot | null>(null);
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty('--mask-fill-custom', `rgba(${r}, ${g}, ${b}, 0.25)`);
    document.documentElement.style.setProperty('--mask-fill-hover-custom', `rgba(${r}, ${g}, ${b}, 0.35)`);
    document.documentElement.style.setProperty('--mask-fill-active-custom', `rgba(${r}, ${g}, ${b}, 0.45)`);
  ...
  const handleAddMask = useCallback(async (rect: { x: number; y: number; width: number; height: number }) => {
  ...
  const handleUpdateMask = useCallback(async (maskId: string, updates: Partial<MaskRegion>) => {
    await updateMask(maskId, updates);
  }, [updateMask]);

  const handleRemoveMask = useCallback(async (maskId: string) => {
    ...
    <div className="app">
      ...
      <header className="header">
        <div className="header-title">
          <svg 
            ...
            aria-label="StageMask logo"
          >
            <path fill="none" stroke="currentColor" strokeWidth="50" strokeMiterlimit="133.3333" d="M342.3,694.1c17.7,15.1,26.6,22.7,60.8,32.3c34.3,9.6,45.6,7.7,68.1,3.8c74-12.6,184.1-53.2,217.2-182.4
            ...
            <path opacity="0.5" fill="none" stroke="currentColor" strokeWidth="50" strokeMiterlimit="133.3333" d="M553.8,270.3l-23.3-91c-14.7-57.3-22-85.9-41.2-100.3c-6.4-4.8-13.6-8.4-21.3-10.6
            ...
            <path fill="none" stroke="currentColor" strokeWidth="50" strokeLinecap="round" strokeMiterlimit="133.3333" d="M528.1,417.3c12.1-16.9,34.6-25.2,56.9-19.3c22.3,6,37.7,24.5,39.7,45.1"/>
            <path opacity="0.5" fill="none" stroke="currentColor" strokeWidth="50" strokeLinecap="round" strokeMiterlimit="133.3333" d="M257.3,272c-12.1-16.9-34.6-25.2-56.9-19.3c-22.3,6-37.7,24.5-39.7,45.1"/>
            <path fill="none" stroke="currentColor" strokeWidth="50" strokeLinecap="round" strokeMiterlimit="133.3333" d="M334.9,365.5c12.1-16.9,34.6-25.2,56.9-19.3c22.3,6,37.7,24.5,39.7,45.1"/>
            <path opacity="0.5" fill="currentColor" stroke="currentColor" strokeMiterlimit="10" d="M470.8,205.7c8,11.2,5.4,26.8-5.8,34.9c-11.2,8-26.9,5.4-34.9-5.8L470.8,205.7z M387.1,176.8
            ...
            <path fill="none" stroke="currentColor" strokeWidth="50" strokeLinecap="round" strokeMiterlimit="133.3333" d="M530.2,586.6c0,0-16.9-39-76.5-55c-59.6-16-93.7,9.4-93.7,9.4"/>
          </svg>
          StageMask
        </div>
        ...
        <aside className="sidebar">
          ...
          <div className="sidebar-content">
            {loading ? (
              ...
              <div className="empty-state">
                <div className="empty-state-text" style={{ color: 'var(--accent-error)' }}>
                  {error}
                </div>
              </div>
            ) : (
      ...
      <div className="status-bar">
        <div className="status-item">
          <span className={`status-dot ${screenshots.length > 0 ? 'error' : 'success'}`} />
